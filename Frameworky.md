...
Měření budu provádět tak, že daný framework nainstaluji do prázdného virtualenvu[^virtualenv] a pak se podívám na jeho celkovou velikost -- ta bude určovat pořadí na stupnici. (Od velikosti odečtu velikost „prázdného“ virtualenvu.)
